  ...
  return (
    <div className="flex flex-col justify-center items-center mb-3 w-full px-2 relative top-36">
      <form
        ...
        className="p-3 rounded-md w-4/5 sm:w-3/5 lg:w-1/4"
      >
        ...
        <div className="flex flex-row justify-center">
          <button className="bg-black text-md px-4 py-1 text-white my-1 rounded-sm">
            Log in
          </button>
        </div>
      ...
      <GoogleButton onClick={handleSignInWithGoogle} className="sm:mb-8" />
