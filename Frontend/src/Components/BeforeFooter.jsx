    ...
    <div className="grid gap-4 sm:grid-cols-2 sm:items-center px-3 sm:px-5 py-5 bg-slate-100 w-full lg:mx-7">
      ...
      <div className="">
        ...
        <div className="my-3 w-full flex flex-row">
          <input
            type="email"
            className="border-1 w-full py-1 px-2 outline-none placeholder:italic"
            placeholder="abc@gmail.com"
            required
          />
          <button
            type="submit"
            className="text-md px-3 py-1 text-white bg-black hover:duration-500 hover:opacity-50"
          >
            Subscribe
          </button>
        </div>
