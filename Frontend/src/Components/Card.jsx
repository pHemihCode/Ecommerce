...
function Card({ rating, title, image, price, id }) {
  ...
  return (
    <div
      key={id}
      className="border-2 p-2 mb-4 sm:my-1 rounded-sm shadow-xl shadow-slate-100"
    >
      ...
      <button
        ...
        className="bg-black hover:opacity-50 text-white px-4 py-1 mb-3 rounded-md text-md"
      >
        Add to Cart
      </button>
